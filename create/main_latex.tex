...
\question{From where can I download the template to generate this list of questions and answers?}\label{new-question}

The template can be downloaded from the following website:
...
\question{Which additional packages are required and from where can I download them?}\label{new-question}

The following packages are required:
\begin{verbatim}
todonotes, tocloft, microtype
\end{verbatim}

The packages can be downloaded from the Comprehensive Tex Archive Network (CTAN):
...
\question{I received 4 zip files. How do I unpack them?}\label{new-question}

Under LINUX you simply type:
\begin{verbatim}
unzip faq.zip
unzip todonotes.zip
unzip tocloft.zip
...
\question{How do I install the additional packages?}\label{new-question}

The content of the additional package files is unpacked to subfolders. Change to the respective subfolder and type:
\begin{verbatim}
latex todonotes.ins
latex tocloft.ins
latex microtype.ins
...
This will generate 3 \texttt{.sty} files \texttt{todonotes.sty}, \texttt{tocloft.sty} and \texttt{microtype.sty}.

Copy these files to the parent directory which should also contain the \texttt{faq.tex} file.
